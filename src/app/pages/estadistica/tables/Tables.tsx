...
const TablesHeader: React.FC<Props> = ({className}) => {
  return (
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder fs-3 mb-1'>Lectura de datos del módulo 1</span>
          <span className='text-muted mt-1 fw-bold fs-7'>Se muestran solo 20</span>
        </h3>
        <div
...
const TablesBody: React.FC<Props> = ({className}) => {
...
export {TablesHeader, TablesBody}
